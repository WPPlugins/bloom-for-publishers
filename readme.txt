...
Geotag your posts to create a local search and mapping visuals for your readers.

== Description ==

Provides geotagging capabilities for your posts and a local search feature if you're a registered publisher on [Bloom](https://www.bloom.li "Bloom").  Geotagging is set by your authors, allowing them to define a location which is placed into web page's metadata (for search engines and social networks).  It then brings each post together into a search tool for your readers to discover your content nearby them.  Sign up on [Bloom](https://www.bloom.li "Bloom") to get started.
...
4. Go to the Settings page in Wordpress to add your Bloom account

== Frequently Asked Questions ==

= How do I geotag my Posts? =

Create or Edit a Post, then scroll down the page to see the “Post Location"
...
posts by neighborhood, city, country or any other imprecise location
description.
...
Bloom’s plugins.  Read more at https://www.bloom.li/advocacy/metadata.
